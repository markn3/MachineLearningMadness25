...
m_2025 = get_predictions("m", 2025)
w_2025 = get_predictions("w", 2025)
all_games_25 = pd.concat([m_2025, w_2025], ignore_index=True)
all_games_25.to_csv(f"./data/submission_stage2.csv", index=False)
